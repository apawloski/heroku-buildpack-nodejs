...
install_nodejs() {
  ...
  if needs_resolution "$version"; then
      # Keep a list of supported versions here and compare
      echo "Only 4.0.0 supported as of now"
  ...
  local download_url="https://nodejs.org/dist/v$version/node-v$version-linux-x64.tar.gz"
